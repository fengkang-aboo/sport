...
<div style="margin-left:0px;">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-left: 20px"><span class="l" style="margin-right: 10px"><a
            ...
            class="btn btn-primary radius" onclick="" href="<?php echo U('Supplier/add');?>"><i
            class="Hui-iconfont">&#xe600;</i> 添加供应商</a></span><a
            href="<?php echo U('Excels/expSupplier');?>?category_id=<?php echo ($category_id); ?>&status=<?php echo ($status); ?>"><input
            class="btn btn-success radius" id="aaa" type="button" value="Excel导出"></a> <span class="r">共有数据：<strong><?php echo ($count); ?></strong> 条</span>
    </div>
            ...
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <?php if(is_array($venue)): $i = 0; $__LIST__ = $venue;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c va-m">
                        ...
                        <td class="td-manage">
                            ...
                            <a style="text-decoration:none" class="ml-5" href="<?php echo U('Venue/venue_branch');?>?id=<?php echo ($v["id"]); ?>" title="编辑">场馆</a>
                        </td>

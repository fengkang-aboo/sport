...
<head>
    ...
    <link rel="Bookmark" href="/sport/cms.fitness.dayaartist.com/Public/admin/images/favicon.ico">
    <link rel="Shortcut Icon" href="/sport/cms.fitness.dayaartist.com/Public/admin/images/favicon.ico"/>
    ...
    <link href="/sport/cms.fitness.dayaartist.com/Public/admin/css/main.css" rel="stylesheet" type="text/css"/>
...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">区块练后台管理系统 V1.0</a>
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li>
                        <a data-title="课程安排" data-href="<?php echo U('Course/course_index');?>" href="<?php echo U('Course/course_index');?>" target="iframe">课程列表</a>
                    </li>
                    <li>
                        <a data-title="老师安排" data-href="<?php echo U('Course/teacher_index');?>" href="<?php echo U('Course/teacher_index');?>" target="iframe">老师列表</a>
                    </li>
                    <li>
...
<!--_footer 作为公共模版分离出去-->
<script type="text/javascript" src="/sport/cms.fitness.dayaartist.com/Public/admin/lib/jquery/1.9.1/jquery.min.js"></script>
<script type="text/javascript" src="/sport/cms.fitness.dayaartist.com/Public/admin/lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="/sport/cms.fitness.dayaartist.com/Public/admin/static/h-ui/js/H-ui.min.js"></script>
<script type="text/javascript" src="/sport/cms.fitness.dayaartist.com/Public/admin/static/h-ui.admin/js/H-ui.admin.js"></script>
<!--/_footer 作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/sport/cms.fitness.dayaartist.com/Public/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>

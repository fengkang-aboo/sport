    ...
    <div class="page-container">
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <tbody>
                <!-- 遍历 -->
                <?php if(is_array($venue)): $i = 0; $__LIST__ = $venue;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c va-m">
                        <td><input type="checkbox" name="delID" value="<?php echo ($v["id"]); ?>"></td>
                        <td><?php echo ($v["id"]); ?></td>
                        <td><img src="<?php echo ($v["img_url"]); ?>" width="100"></td>
                        <td><?php echo ($v["name"]); ?></td>
                        <td><?php echo ($v["business_hours"]); ?></td>
                        ...
                        <td class="td-manage">
                            <a style="text-decoration:none" class="ml-5" href="<?php echo U('Venue/venue_preview');?>?id=<?php echo ($v["id"]); ?>" title="预览">预览</a>
                            <a style="text-decoration:none" class="ml-5" href="<?php echo U('Venue/add_venue');?>?id=<?php echo ($v["id"]); ?>" title="编辑">编辑</a>
                            <a style="text-decoration:none" class="ml-5" href="<?php echo U('Venue/venue_index');?>?pid=<?php echo ($v["id"]); ?>" title="分店">分店</a>
                        </td>

    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <?php if(is_array($userlist)): $i = 0; $__LIST__ = $userlist;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($v["id"]); ?>" data-name="<?php echo ($v["name"]); ?>" class="text-c">
                    ...
                    <td><?php echo ($v["id"]); ?></td>
                    <td>
                        <?php if($v["nickname"] != null): echo ($v["nickname"]); ?>
                            <?php else: ?>
                            未授权<?php endif; ?>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php if($v["language"] != null): echo ($v["language"]); ?>
                            <?php else: ?>
                            未填写<?php endif; ?>
                    </td>
                    <td class="text-l">
                        <?php if($v["country"] != null): echo ($v["country"]); echo ($v["province"]); echo ($v["city"]); ?>
                            <?php else: ?>
                            未授权<?php endif; ?>
                    </td>
...
<script type="text/javascript" src="/sport/cms.fitness.dayaartist.com/Public/lib/laypage/1.2/laypage.js"></script>
